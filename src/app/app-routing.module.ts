...
const routes: Routes = [
    ...
    { path: "visualizacao", component: VisualizacoesComponent, canActivate: [AppAuthGuard]},
    { path: "visualizacao-detail", component: VisualizacoesDetailComponent, canActivate: [AppAuthGuard]},
    { path: "redefinirSenha", component: RedefinirSenhaComponent, canActivate: [AppAuthGuard] },
    ...
    { path: "localrisco", component: LocalRiscoComponent, canActivate: [AppAuthGuard] },
    { path: "local-risco-add", component: LocalRiscoAddComponent, canActivate: [AppAuthGuard] },
    { path: "agua", component: AguaComponent, canActivate: [AppAuthGuard] },
    { path: "peso", component: PesoComponent, canActivate: [AppAuthGuard] },
